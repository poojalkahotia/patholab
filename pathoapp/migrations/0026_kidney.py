# Generated by Django 5.1.1 on 2024-11-12 02:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodurea', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('serumcreatinine', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('bun', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('uricacid', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
